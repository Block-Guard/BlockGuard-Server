...
public class NewsSaveScheduler {
    ...
    private static final Map<Category, List<String>> KEYWORDS_PER_CATEGORY = Map.ofEntries(
            ...
            Map.entry(Category.PUBLIC_IMPERSONATION,  List.of("공공기관 사칭", "국세청 사칭", "금감원 사칭", "검찰 사칭", "경찰 사칭", "수사기관 사칭")),
            Map.entry(Category.PARTTIME_SCAM,         List.of("알바 사기", "부업 사기", "구인 사기")),
            Map.entry(Category.GOVT_SUBSIDY_FAKE,     List.of("정부지원금 사기", "보조금 사기", "지원금 사칭")),
            Map.entry(Category.PARCEL_SCAM,           List.of("택배 사기", "택배 문자 사기", "배송 사기")),
            Map.entry(Category.INVESTMENT_SCAM,       List.of("투자 사기", "코인 투자 사기", "주식 리딩방 사기")),
            Map.entry(Category.FAKE_PAYMENT,          List.of("허위 결제 사기", "결제 승인 사기", "결제 피싱")),
